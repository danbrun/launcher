...
class ShortcutTileViewBinder(private val shortcutTileListener: ShortcutTileListener? = null) :
    ViewBinder<ShortcutTileViewHolder, ShortcutTileViewItem> {

    override val viewType: Int = R.id.shortcut_tile_view_type_id

    override fun createViewHolder(parent: ViewGroup): ShortcutTileViewHolder {
        return ShortcutTileViewHolder(parent.inflate(R.layout.shortcut_tile_view))
    }

    override fun bindViewHolder(holder: ShortcutTileViewHolder, viewItem: ShortcutTileViewItem) {
...
class ShortcutTileViewHolder(view: View) : ViewHolder(view) {
...
class ShortcutTileViewItem(val info: ShortcutInfo, val name: CharSequence, val icon: Drawable?) :
    ...
    override fun areItemsTheSame(other: ViewItem): Boolean =
        other is ShortcutTileViewItem && info.`package` == other.info.`package` && info.id == other.info.id

    override fun areContentsTheSame(other: ViewItem): Boolean = false
}
